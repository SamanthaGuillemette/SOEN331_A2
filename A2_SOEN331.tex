...
\indent 6. $faster \xrightarrow {\text { accelerate / increase speed }} faster$\\
\indent 7. $faster \xrightarrow {\text { decelerate / decrease speed }} slower$\\
\indent 8. $slower \xrightarrow {\text { decelerate / decrease speed }} slower$\\
