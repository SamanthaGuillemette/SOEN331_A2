...
\indent $distanceOfCar, minSpeedRange, maxSpeedRange, minDistance: \mathbb{R} $\\
\noindent $\Lambda$: Transition specifications\\
\indent 1. $lane~start\xrightarrow {\text{maintain speed [d\textgreater = minDistance]}} maintain~car~speed$\\
...
\indent 4. $lane~start\xrightarrow {\text{maintain speed [d\textless minDistance]/c to t}} tailing~mode$\\
\indent 5. $lane~start\xrightarrow {\text{maintain speed [s\textgreater maxSpeedRange \& s\textless minSpeedRange]/c to t}} tailing~mode$\\
\indent 6. $lane~start\xrightarrow {\text{switch lane[car not in t]}} change~lane~mode$\\
\indent 7. $lane~start\xrightarrow {\text{switch lane[car in t]/c to n}} cruise~mode$\\
\indent 8. $lane~start\xrightarrow {\text{switch lane;cannot change lane/panic}} panic~mode$\\
...
\noindent $V: targetLane: \{car~in~t, car~not~in~t\}$,\\
\noindent $\Lambda$: Transition specifications\\
\indent 1. $navigation~start\xrightarrow {\text{d on left/turn left}} turn~left$\\
\indent 2. $navigation~start\xrightarrow {\text{d on right/turn right}} turn~right$\\
\indent 3. $navigation~start\xrightarrow {\text{TLA[car not in t]}} turn~left~ahead$\\
\indent 4. $navigation~start\xrightarrow {\text{TRA[car not in t]}} turn~right~ahead$\\
\indent 5. $navigation~start\xrightarrow {\text{d ahead/dest ahead; car in t}} turn~left~ahead$\\
